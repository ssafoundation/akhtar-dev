      ...
      <div className="container-shell grid gap-14 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          <h2 className="headline text-4xl font-semibold sm:text-6xl">
            A focused stack orbiting around business-grade execution.
          </h2>
          <p className="mt-6 text-lg leading-8 text-muted">
            No noisy progress bars. The stack is a connected system: frontend
            polish, CMS flexibility, eCommerce fluency, animation, and clean
